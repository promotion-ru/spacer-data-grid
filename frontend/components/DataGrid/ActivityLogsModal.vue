              ...
              <div class="bg-gray-50 rounded-md p-3 space-y-2">
                ...
                >
                  ...
                  <div class="flex items-center space-x-2 mt-1 sm:mt-0">
                    <span :title="change.old_value" class="px-2 py-1 bg-red-100 text-red-700 rounded text-xs max-w-32 truncate">
                      {{ change.old_value }}
                    </span>
                    <i class="pi pi-arrow-right text-gray-400 text-xs"></i>
                    <span :title="change.new_value" class="px-2 py-1 bg-green-100 text-green-700 rounded text-xs max-w-32 truncate">
                      {{ change.new_value }}
                    </span>
                  </div>
                </div>
...
// Отслеживаем изменения поиска с debounce
watch(searchQuery, () => {
  debouncedFetchLogs()
})
